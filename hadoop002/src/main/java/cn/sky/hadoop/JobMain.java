...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path("hdfs://localhost:9000/usr/hadoop/in"));
        ...
        // 设置输出路径
        TextOutputFormat.setOutputPath(job, new Path("hdfs://localhost:9000/usr/hadoop/temperature"));
